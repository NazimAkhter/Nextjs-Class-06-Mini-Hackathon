    ...
    return (
        <section className="bg-gray-200 h-screen">
            ...
            <div className="container mx-auto max-w-5xl bg-white grid grid-cols-4">
                <div className=" h-96">
                    <h1 className='text-3xl text-green-600 text-center mt-12'>PKR 60,00,000</h1>
                ...
                <div className="border-gray-200 col-span-3 h-96">
                    <Image src={toyota} alt='Totyota Car' width={500} height={400} className='w-3/4 mx-auto my-auto hover:w-5/6 duration-1000'/>
                </div>
