    ...
    return (
        <section className="bg-gray-200 h-screen">
            ...
            <div className="container mx-auto max-w-5xl bg-white grid grid-cols-4">
                <div className=" h-96">
                    <h1 className='text-3xl text-green-600 text-center mt-12'>PKR 30,00,000</h1>
                ...
                <div className="border-gray-200 col-span-3 h-96">
                    <Image src={suzukialto} alt='Suzuki Alto Car' width={500} height={400} className='w-3/5 mx-auto my-8 hover:w-4/5 duration-1000 '/>
                </div>
